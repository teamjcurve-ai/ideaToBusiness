...
import { Play, Download, RotateCw, Loader2, Lock } from 'lucide-react';
...
export default function Step2Page({ params }: PageProps) {
  ...
  const prevStep = currentProject?.steps?.find((s: any) => s.stepNumber === 1);
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6">
          <div className="glass-heavy rounded-3xl p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              1단계를 완료해야 이 단계를 시작할 수 있습니다.
            </p>
            <button
              onClick={() => router.push(`/projects/${id}/step/1`)}
